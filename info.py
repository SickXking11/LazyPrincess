...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Rx Moviez™](https://t.me/rx_moviez)</b>⚡\n\n🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [MovizTube™](https://t.me/rx_moviez)</b> ↭  🔥")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','rx_moviez') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','rx_moviez') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','rx_moviez') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','ultroidofficial')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "rx_moviez") #[ without @ ]
...
DOWNLOAD_TEXT_URL = "https://t.me/Rx_botz/4"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/Rx_botz"
